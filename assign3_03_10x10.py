...
def main():
    ...
    while 1:
        ...
        xblocks = range(00, 240, 16)
        yblocks = range(00, 240, 16)    
        count=0
        avgcolor=[0,0,0]
        sumcolor=[0,0,0]
        sumcolorlist=[]
        ...
        for x in xblocks:
                ...
                for y in yblocks:
                        ...
                        for offset in range(0,16,1): #define scan area
                          ...
                          if frame%100==0:
                            ...
                            pickcolor=screen.get_at((200+x+16-offset, 200+y+offset)) #other diagonal
                            sumcolor[0]+=pickcolor[0]
                          ...
                          screen.set_at((200+x+16-offset, 200+y+offset), justacolor)
        ...
        if frame%100==0:
            ...
            for sumcolor in sumcolorlist:
                avgcolorlist.append(40*sumcolor/count)
            #print sumcolorlist
